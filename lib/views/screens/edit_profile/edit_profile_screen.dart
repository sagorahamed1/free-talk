      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: CustomNetworkImage(
                  ...
                  imageUrl:  selectedAvatarUrl != null
                      ?  selectedAvatarUrl.toString()  : AppImages.maleAvatars.first , height: 150.h, width: 150.w)
            ),
            ...
            firebase.updateData(userId: userId.toString(), collection: "users", updatedData: body);
